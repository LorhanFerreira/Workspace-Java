...
public class L061_Questao06 {
	...
	public static void main(String[] args) {
		...
		peso = Teclado.lerDouble("\nFavor informe seu peso: ");
		cod = Teclado.lerInt("Favor, informe o código do planeta em que deseja saber o seu peso:" );
		pesoNoPlaneta = (peso/10);
		
		switch (cod) {
		case 1:
			System.out.println("O seu peso em Mercúrio é " + pesoNoPlaneta * 0.37);
			break;
		case 2:
			System.out.println("O seu peso em Vênus é " + pesoNoPlaneta * 0.88);
			break;
		case 3:
			System.out.println("O seu peso em Marte é " + pesoNoPlaneta * 0.38);
			break;
		case 4:
			System.out.println("O seu peso em Júpiter é " + pesoNoPlaneta * 2.64);
			break;
		case 5:
			System.out.println("O seu peso em Saturno é " + pesoNoPlaneta * 1.15);
			break;
		case 6:
			System.out.println("O seu peso em Urano é " + pesoNoPlaneta * 1.17);
			break;
		default:
			System.out.println("O código inserido está incorreto.");
			break;
		}
